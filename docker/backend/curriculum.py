...
_TRANSLATIONS = {
    ...
    "ru": {
        ...
        "Peça em um restaurante": ["У меня есть столик.", "Меню, пожалуйста.", "Я возьму суп.", "Я возьму курицу.", "Я хотел бы воды.", "Я хотел бы десерт.", "Без мяса, пожалуйста.", "Что вы рекомендуете?", "Счёт, пожалуйста.", "Большое спасибо."],
        "Compartilhe contato": ["Мой номер один два три.", "Мой имейл здесь.", "Это мой адрес.", "Меня зовут Виктор.", "Моя фамилия Фернандес.", "Номер четыре пять шесть.", "Повторите, пожалуйста.", "Я называю своё имя по буквам.", "Я пишу сообщение.", "Вот мой контакт."],
