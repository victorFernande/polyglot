...
export const useStore = create((set, get) => ({
  ...
  activeWave: null,
  activePhase: null,
  activeLanguageProgress: null,
  exerciseLanguageProgress: [],
  recentLogs: [],
  achievements: [],
  levelInfo: null,
  dailyGoal: null,
  ...
  setDashboard: (data) => set({
    ...
    activeLanguageProgress: data.active_language_progress,
    exerciseLanguageProgress: data.exercise_language_progress || [],
